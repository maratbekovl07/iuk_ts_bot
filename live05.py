...
def main(message):
    ...
    main_menu.add(KeyboardButton("🔒 Восстановление доступа AVN"), KeyboardButton("✉️ Обращение к IT Hub"))

    bot.send_message(
        message.chat.id,
        "Привет, пользователь. Вас приветствует чат-бот Политехнического колледжа МУКР! 🎓\n\n"
